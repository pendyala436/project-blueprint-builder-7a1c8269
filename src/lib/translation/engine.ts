...
class SemanticTranslationEngine implements TranslationEngine {
  ...
  private getSemanticBase(language: Language): Map<string, string> {
    ...
    switch (language.scriptName) {
      ...
      // Note: Duplicate cases for Vai, Tifinagh, Canadian_Aboriginal, Osmanya, Bamum, Cherokee, Adlam, Miao
      // were removed - they are already defined above around lines 1177-1340
