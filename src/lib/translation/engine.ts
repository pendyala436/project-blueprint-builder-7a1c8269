...
class SemanticTranslationEngine implements TranslationEngine {
  ...
  private getSemanticBase(language: Language): Map<string, string> {
    ...
    switch (language.scriptName) {
      ...
      // ============= TAI VIET SCRIPT =============
      case 'Tai_Viet':
        base.set('ꪀ', 'k'); base.set('ꪁ', 'kh'); base.set('ꪂ', 'kh'); base.set('ꪃ', 'kh');
        base.set('ꪄ', 'kh'); base.set('ꪅ', 'kh'); base.set('ꪆ', 'ng'); base.set('ꪇ', 'ng');
        base.set('ꪈ', 'ch'); base.set('ꪉ', 's'); base.set('ꪊ', 's'); base.set('ꪋ', 'y');
        base.set('ꪌ', 'd'); base.set('ꪍ', 't'); base.set('ꪎ', 'th'); base.set('ꪏ', 'th');
        base.set('ꪐ', 'n'); base.set('ꪑ', 'n'); base.set('ꪒ', 'b'); base.set('ꪓ', 'p');
        base.set('ꪔ', 'ph'); base.set('ꪕ', 'f'); base.set('ꪖ', 'ph'); base.set('ꪗ', 'f');
        base.set('ꪘ', 'm'); base.set('ꪙ', 'y'); base.set('ꪚ', 'r'); base.set('ꪛ', 'l');
        base.set('ꪜ', 'w'); base.set('ꪝ', 'h'); base.set('ꪞ', 'o'); base.set('ꪟ', 'h');
        base.set('ꪠ', 'kw'); base.set('ꪡ', 'khw'); base.set('ꪢ', 'xw'); base.set('ꪣ', 'nw');
        base.set('ꪤ', 'a'); base.set('ꪥ', 'aa'); base.set('ꪦ', 'i'); base.set('ꪧ', 'u');
        base.set('ꪨ', 'e'); base.set('ꪩ', 'o'); base.set('ꪪ', 'ue'); base.set('ꪫ', 'ai');
        break;

      // ============= VAI SCRIPT (LIBERIA) =============
      case 'Vai':
        base.set('ꔀ', 'ee'); base.set('ꔁ', 'en'); base.set('ꔂ', 'hee'); base.set('ꔃ', 'wee');
        base.set('ꔄ', 'ween'); base.set('ꔅ', 'pee'); base.set('ꔆ', 'bhee'); base.set('ꔇ', 'bee');
        base.set('ꔈ', 'mbee'); base.set('ꔉ', 'kpee'); base.set('ꔊ', 'mgbee'); base.set('ꔋ', 'gbee');
        base.set('ꔌ', 'fee'); base.set('ꔍ', 'vee'); base.set('ꔎ', 'tee'); base.set('ꔏ', 'thee');
        base.set('ꔐ', 'dhee'); base.set('ꔑ', 'dee'); base.set('ꔒ', 'ndee'); base.set('ꔓ', 'see');
        base.set('ꔔ', 'shee'); base.set('ꔕ', 'zee'); base.set('ꔖ', 'zhee'); base.set('ꔗ', 'cee');
        base.set('ꔘ', 'jee'); base.set('ꔙ', 'njee'); base.set('ꔚ', 'yee'); base.set('ꔛ', 'kee');
        base.set('ꔜ', 'nggee'); base.set('ꔝ', 'gee'); base.set('ꔞ', 'mee'); base.set('ꔟ', 'nee');
        base.set('ꔠ', 'nyee'); base.set('ꔡ', 'i'); base.set('ꔢ', 'a'); base.set('ꔣ', 'o');
        base.set('ꔤ', 'u'); base.set('ꔥ', 'e'); base.set('ꕙ', 'vai'); base.set('ꔤ', 'i');
        break;

      // ============= N'KO SCRIPT (MANDING LANGUAGES) =============
      case 'Nko':
        base.set('ߊ', 'a'); base.set('ߋ', 'e'); base.set('ߌ', 'i'); base.set('ߍ', 'ee');
        base.set('ߎ', 'u'); base.set('ߏ', 'o'); base.set('ߐ', 'o'); base.set('ߑ', 'oa');
        base.set('ߒ', 'n'); base.set('ߓ', 'ba'); base.set('ߔ', 'pa'); base.set('ߕ', 'ta');
        base.set('ߖ', 'ja'); base.set('ߗ', 'cha'); base.set('ߘ', 'da'); base.set('ߙ', 'ra');
        base.set('ߚ', 'rra'); base.set('ߛ', 'sa'); base.set('ߜ', 'gba'); base.set('ߝ', 'fa');
        base.set('ߞ', 'ka'); base.set('ߟ', 'la'); base.set('ߠ', 'na'); base.set('ߡ', 'ma');
        base.set('ߢ', 'nya'); base.set('ߣ', 'na'); base.set('ߤ', 'ha'); base.set('ߥ', 'wa');
        base.set('ߦ', 'ya'); base.set('ߧ', 'nyn');
        break;
      ...
      case 'Tifinagh':
        ...
        base.set('ⴼ', 'f'); base.set('ⴽ', 'k'); base.set('ⴾ', 'k'); base.set('ⴿ', 'k');
        base.set('ⵀ', 'h'); base.set('ⵁ', 'h'); base.set('ⵂ', 'h'); base.set('ⵃ', 'h');
        base.set('ⵄ', 'a'); base.set('ⵅ', 'kh'); base.set('ⵆ', 'kh'); base.set('ⵇ', 'q');
        base.set('ⵈ', 'q'); base.set('ⵉ', 'i'); base.set('ⵊ', 'j'); base.set('ⵋ', 'j');
        base.set('ⵌ', 'j'); base.set('ⵍ', 'l'); base.set('ⵎ', 'm'); base.set('ⵏ', 'n');
        base.set('ⵐ', 'ny'); base.set('ⵑ', 'ng'); base.set('ⵒ', 'p'); base.set('ⵓ', 'u');
        base.set('ⵔ', 'r'); base.set('ⵕ', 'r'); base.set('ⵖ', 'gh'); base.set('ⵗ', 'gh');
        base.set('ⵘ', 'j'); base.set('ⵙ', 's'); base.set('ⵚ', 's'); base.set('ⵛ', 'sh');
        base.set('ⵜ', 't'); base.set('ⵝ', 't'); base.set('ⵞ', 'ch'); base.set('ⵟ', 't');
        base.set('ⵠ', 'v'); base.set('ⵡ', 'w'); base.set('ⵢ', 'y'); base.set('ⵣ', 'z');
        base.set('ⵤ', 'z'); base.set('ⵥ', 'z'); base.set('ⵯ', 'w');
        break;

      // ============= CANADIAN ABORIGINAL SYLLABICS =============
      case 'Canadian_Aboriginal':
        base.set('ᐁ', 'e'); base.set('ᐂ', 'ee'); base.set('ᐃ', 'i'); base.set('ᐄ', 'ii');
        base.set('ᐅ', 'o'); base.set('ᐆ', 'oo'); base.set('ᐇ', 'oo'); base.set('ᐊ', 'a');
        base.set('ᐋ', 'aa'); base.set('ᐌ', 'we'); base.set('ᐍ', 'wee'); base.set('ᐎ', 'wi');
        base.set('ᐏ', 'wii'); base.set('ᐐ', 'wii'); base.set('ᐑ', 'wii'); base.set('ᐒ', 'wo');
        base.set('ᐓ', 'woo'); base.set('ᐔ', 'woo'); base.set('ᐕ', 'woo'); base.set('ᐖ', 'wa');
        base.set('ᐗ', 'waa'); base.set('ᐘ', 'waa'); base.set('ᐙ', 'waa'); base.set('ᐚ', 'ai');
        base.set('ᐛ', 'w'); base.set('ᐯ', 'pe'); base.set('ᐱ', 'pi'); base.set('ᐳ', 'po');
        base.set('ᐸ', 'pa'); base.set('ᑌ', 'te'); base.set('ᑎ', 'ti'); base.set('ᑐ', 'to');
        base.set('ᑕ', 'ta'); base.set('ᑫ', 'ke'); base.set('ᑭ', 'ki'); base.set('ᑯ', 'ko');
        base.set('ᑲ', 'ka'); base.set('ᒉ', 'ce'); base.set('ᒋ', 'ci'); base.set('ᒍ', 'co');
        base.set('ᒐ', 'ca'); base.set('ᒣ', 'me'); base.set('ᒥ', 'mi'); base.set('ᒧ', 'mo');
        base.set('ᒪ', 'ma'); base.set('ᓀ', 'ne'); base.set('ᓂ', 'ni'); base.set('ᓄ', 'no');
        base.set('ᓇ', 'na'); base.set('ᓭ', 'se'); base.set('ᓯ', 'si'); base.set('ᓱ', 'so');
        base.set('ᓴ', 'sa'); base.set('ᔦ', 'ye'); base.set('ᔨ', 'yi'); base.set('ᔪ', 'yo');
        base.set('ᔭ', 'ya');
        break;

      // ============= OSMANYA (SOMALI) SCRIPT =============
      case 'Osmanya':
        base.set('𐒀', 'a'); base.set('𐒁', 'ba'); base.set('𐒂', 'ta'); base.set('𐒃', 'ja');
        base.set('𐒄', 'xa'); base.set('𐒅', 'kha'); base.set('𐒆', 'da'); base.set('𐒇', 'ra');
        base.set('𐒈', 'sa'); base.set('𐒉', 'sha'); base.set('𐒊', 'dha'); base.set('𐒋', 'ca');
        base.set('𐒌', 'ga'); base.set('𐒍', 'fa'); base.set('𐒎', 'qa'); base.set('𐒏', 'ka');
        base.set('𐒐', 'la'); base.set('𐒑', 'ma'); base.set('𐒒', 'na'); base.set('𐒓', 'wa');
        base.set('𐒔', 'ha'); base.set('𐒕', 'ya'); base.set('𐒖', 'aa'); base.set('𐒗', 'e');
        base.set('𐒘', 'i'); base.set('𐒙', 'o'); base.set('𐒚', 'u'); base.set('𐒛', 'aa');
        break;

      // ============= BAMUM SCRIPT =============
      case 'Bamum':
        base.set('ꚠ', 'ka'); base.set('ꚡ', 'u'); base.set('ꚢ', 'ku'); base.set('ꚣ', 'ee');
        base.set('ꚤ', 're'); base.set('ꚥ', 'tee'); base.set('ꚦ', 'nyi'); base.set('ꚧ', 'la');
        base.set('ꚨ', 'rii'); base.set('ꚩ', 'ri'); base.set('ꚪ', 'mo'); base.set('ꚫ', 'mbaa');
        base.set('ꚬ', 'tat'); base.set('ꚭ', 'nshut'); base.set('ꚮ', 'njee'); base.set('ꚯ', 'm');
        base.set('ꚰ', 'suu'); base.set('ꚱ', 'mu'); base.set('ꚲ', 'shii'); base.set('ꚳ', 'si');
        base.set('ꚴ', 'sheux'); base.set('ꚵ', 'seux'); base.set('ꚶ', 'kyee'); base.set('ꚷ', 'ket');
        break;
      ...
      // ============= ADlam (Fulani) SCRIPT =============
      case 'Adlam':
        base.set('𞤀', 'a'); base.set('𞤁', 'da'); base.set('𞤂', 'la'); base.set('𞤃', 'ma');
        base.set('𞤄', 'ba'); base.set('𞤅', 'sa'); base.set('𞤆', 'pa'); base.set('𞤇', 'bha');
        base.set('𞤈', 'ra'); base.set('𞤉', 'e'); base.set('𞤊', 'fa'); base.set('𞤋', 'i');
        base.set('𞤌', 'o'); base.set('𞤍', 'dha'); base.set('𞤎', 'ya'); base.set('𞤏', 'wa');
        base.set('𞤐', 'na'); base.set('𞤑', 'ka'); base.set('𞤒', 'ya'); base.set('𞤓', 'u');
        base.set('𞤔', 'ja'); base.set('𞤕', 'cha'); base.set('𞤖', 'ha'); base.set('𞤗', 'qa');
        base.set('𞤘', 'ga'); base.set('𞤙', 'nya'); base.set('𞤚', 'ta'); base.set('𞤛', 'nha');
        break;

      // ============= MIAO/POLLARD SCRIPT =============
      case 'Miao':
        base.set('𖼀', 'b'); base.set('𖼁', 'p'); base.set('𖼂', 'mp'); base.set('𖼃', 'f');
        base.set('𖼄', 'v'); base.set('𖼅', 'm'); base.set('𖼆', 'hm'); base.set('𖼇', 'w');
        base.set('𖼈', 'd'); base.set('𖼉', 't'); base.set('𖼊', 'nd'); base.set('𖼋', 'l');
        base.set('𖼌', 'hl'); base.set('𖼍', 'g'); base.set('𖼎', 'k'); base.set('𖼏', 'ng');
        base.set('𖼐', 'h'); base.set('𖼑', 'dz'); base.set('𖼒', 'ts'); base.set('𖼓', 's');
        base.set('𖼔', 'sh'); base.set('𖼕', 'zh'); base.set('𖼖', 'ch'); base.set('𖼗', 'j');
        break;

      // ============= MEDEFAIDRIN SCRIPT =============
      case 'Medefaidrin':
        base.set('𖹀', 'm'); base.set('𖹁', 'b'); base.set('𖹂', 's'); base.set('𖹃', 't');
        base.set('𖹄', 'k'); base.set('𖹅', 'n'); base.set('𖹆', 'f'); base.set('𖹇', 'a');
        base.set('𖹈', 'p'); base.set('𖹉', 'e'); base.set('𖹊', 'o'); base.set('𖹋', 'i');
        base.set('𖹌', 'u'); base.set('𖹍', 'oe'); base.set('𖹎', 'ue'); base.set('𖹏', 'g');
        break;

      // ============= TANGUT SCRIPT =============
      case 'Tangut':
        // Tangut is logographic - use simplified phonetic
        base.set('𗀀', 'lji'); base.set('𗀁', 'gju'); base.set('𗀂', 'nji');
        break;
