...
const SEMANTIC_PHONETIC_PATTERNS: SemanticPhoneticPattern[] = [
  // GREETINGS - Universal greeting sound patterns
  {
    ...
    patterns: [
      ...
      { sounds: ['vanakkam'], languages: ['tamil'] },
      { sounds: ['namaskaram', 'namaskaaram'], languages: ['telugu', 'malayalam', 'kannada'] },
      ...
      { sounds: ['ni hao', 'nihao'], languages: ['mandarin'] },
      { sounds: ['konnichiwa', 'konnichi'], languages: ['japanese'] },
      { sounds: ['annyeong', 'anyeong'], languages: ['korean'] },
  ...
  // THANKS - Gratitude patterns  
  {
    ...
    patterns: [
      ...
      { sounds: ['dhanyavad', 'dhanyavaad', 'shukriya'], languages: ['hindi'] },
      { sounds: ['dhonnobad', 'dhanyabad'], languages: ['bengali', 'assamese'] },
      { sounds: ['nandri'], languages: ['tamil'] },
      { sounds: ['dhanyavaadalu', 'dhanyavaadamulu'], languages: ['telugu'] },
      { sounds: ['dhanyavad'], languages: ['marathi', 'gujarati'] },
      ...
      { sounds: ['shukran'], languages: ['arabic'] },
      { sounds: ['arigatou', 'arigatoo'], languages: ['japanese'] },
      { sounds: ['xie xie', 'xiexie'], languages: ['mandarin'] },
      { sounds: ['spasibo'], languages: ['russian'] },
      { sounds: ['kamsahamnida', 'gomawo'], languages: ['korean'] },
  ...
  // APOLOGY patterns
  {
    ...
    patterns: [
      ...
      { sounds: ['maaf', 'maafi', 'kshama'], languages: ['hindi', 'urdu'] },
      { sounds: ['dukkhito', 'maaf koro'], languages: ['bengali'] },
      { sounds: ['kshamisi', 'kshaminchandee'], languages: ['telugu'] },
      { sounds: ['mannikkanum'], languages: ['tamil'] },
      { sounds: ['pardon', 'desole'], languages: ['french'] },
      { sounds: ['perdon', 'lo siento'], languages: ['spanish'] },
      { sounds: ['gomen', 'sumimasen'], languages: ['japanese'] },
      { sounds: ['izvinite'], languages: ['russian'] },
      { sounds: ['duibuqi'], languages: ['mandarin'] },
      { sounds: ['mianhae', 'joesonghamnida'], languages: ['korean'] },
    ],
    targetMappings: {
  ...
  // AFFIRMATION patterns (yes/ok)
  {
    ...
    patterns: [
      ...
      { sounds: ['haan', 'ha', 'ji'], languages: ['hindi', 'urdu'] },
      { sounds: ['avunu', 'emo'], languages: ['telugu'] },
      { sounds: ['aamam', 'aama'], languages: ['tamil'] },
      { sounds: ['ho', 'hoi'], languages: ['marathi', 'gujarati'] },
      { sounds: ['oui'], languages: ['french'] },
      { sounds: ['si'], languages: ['spanish', 'italian'] },
      { sounds: ['da', 'da da'], languages: ['russian'] },
      { sounds: ['hai'], languages: ['japanese'] },
      { sounds: ['shi', 'dui'], languages: ['mandarin'] },
      { sounds: ['ne', 'ye'], languages: ['korean'] },
      { sounds: ['evet'], languages: ['turkish'] },
      { sounds: ['naam', 'aywa'], languages: ['arabic'] },
    ],
    targetMappings: {
      hindi: ['haan', 'ji haan'],
      bengali: ['hyan', 'achha'],
  ...
  // NEGATION patterns (no)
  {
    ...
    patterns: [
      ...
      { sounds: ['nahi', 'naa', 'na'], languages: ['hindi', 'urdu'] },
      { sounds: ['kaadu', 'ledu'], languages: ['telugu'] },
      { sounds: ['illa', 'illai'], languages: ['tamil'] },
      { sounds: ['nahi'], languages: ['marathi'] },
      { sounds: ['na'], languages: ['gujarati', 'bengali'] },
      { sounds: ['non'], languages: ['french'] },
      { sounds: ['niet'], languages: ['russian'] },
      { sounds: ['iie'], languages: ['japanese'] },
      { sounds: ['bushi', 'meiyou'], languages: ['mandarin'] },
      { sounds: ['anio', 'aniyo'], languages: ['korean'] },
      { sounds: ['hayir'], languages: ['turkish'] },
      { sounds: ['la'], languages: ['arabic'] },
    ],
    targetMappings: {
      hindi: ['nahi'],
      bengali: ['na'],
  ...
  // LOVE/AFFECTION patterns
  {
    ...
    patterns: [
      ...
      { sounds: ['pyaar', 'prem', 'mohabbat'], languages: ['hindi'] },
      { sounds: ['bhalobasa', 'bhalobashi'], languages: ['bengali'] },
      { sounds: ['prema', 'prēma'], languages: ['telugu', 'kannada'] },
      { sounds: ['kaadhal', 'anbu'], languages: ['tamil'] },
      ...
      { sounds: ['lyubov'], languages: ['russian'] },
      { sounds: ['ai', 'aishiteru'], languages: ['japanese'] },
      { sounds: ['sarang'], languages: ['korean'] },
      { sounds: ['hub'], languages: ['arabic'] },
    ],
    targetMappings: {
      hindi: ['pyaar', 'prem'],
      bengali: ['bhalobasa'],
  ...
  // HOW ARE YOU patterns
  {
    ...
    patterns: [
      ...
      { sounds: ['ela unnaru', 'ela unnav'], languages: ['telugu'] },
  ...
  // I'M FINE/GOOD patterns
  {
    ...
    patterns: [
      ...
      { sounds: ['baagunnanu', 'baagaa'], languages: ['telugu'] },
