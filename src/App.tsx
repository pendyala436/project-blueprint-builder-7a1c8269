...
// ProtectedRoute is NOT lazy-loaded — it guards every route and must be available immediately
...
const AdminStatementsPage = lazy(() => import(/* webpackChunkName: "admin" */ "./pages/admin/AdminStatementsPage"));
      ...
      <Suspense fallback={null}>
        <AutoLogoutWrapper>
          <Routes>
            ...
            <Route path="/admin/statements" element={<LazyRoute component={AdminStatementsPage} requiredRole="admin" />} />
