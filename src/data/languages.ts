...
export const languages: Language[] = [
  ...
  { code: "dyu", name: "Dyula", nativeName: "Julakan", script: "Latin" },
  { code: "efi", name: "Efik", nativeName: "Efik", script: "Latin" },
  { code: "fon", name: "Fon", nativeName: "Fon", script: "Latin" },
  { code: "fuv", name: "Nigerian Fulfulde", nativeName: "Fulfulde", script: "Latin" },
  { code: "gaa", name: "Ga", nativeName: "Gã", script: "Latin" },
  { code: "gbr", name: "Gbari", nativeName: "Gwari", script: "Latin" },
  { code: "grn", name: "Guaraní", nativeName: "Avañe'ẽ", script: "Latin" },
  { code: "gur", name: "Farefare", nativeName: "Gurene", script: "Latin" },
  { code: "gux", name: "Gourmanchéma", nativeName: "Gulimancema", script: "Latin" },
  { code: "ibb", name: "Ibibio", nativeName: "Ibibio", script: "Latin" },
  { code: "idu", name: "Idoma", nativeName: "Idoma", script: "Latin" },
  { code: "ijs", name: "Ijo", nativeName: "Ijọ", script: "Latin" },
  { code: "kbp", name: "Kabiyé", nativeName: "Kabɩyɛ", script: "Latin" },
  { code: "kea", name: "Kabuverdianu", nativeName: "Kriolu", script: "Latin" },
  ...
  { code: "kpe", name: "Kpelle", nativeName: "Kpɛlɛ", script: "Latin" },
  { code: "lgg", name: "Lugbara", nativeName: "Lugbarati", script: "Latin" },
  { code: "lua", name: "Luba-Kasai", nativeName: "Tshiluba", script: "Latin" },
  { code: "lub", name: "Luba-Katanga", nativeName: "Kiluba", script: "Latin" },
  { code: "luo", name: "Luo", nativeName: "Dholuo", script: "Latin" },
  { code: "men", name: "Mende", nativeName: "Mɛnde", script: "Latin" },
  { code: "mos", name: "Mossi", nativeName: "Mòoré", script: "Latin" },
  ...
  { code: "nso", name: "Northern Sotho", nativeName: "Sesotho sa Leboa", script: "Latin" },
  { code: "nyn", name: "Nyankole", nativeName: "Runyankole", script: "Latin" },
  ...
  { code: "seh", name: "Sena", nativeName: "Cisena", script: "Latin" },
  { code: "snk", name: "Soninke", nativeName: "Soninkanxanne", script: "Latin" },
  ...
  { code: "arn", name: "Mapudungun", nativeName: "Mapuzugun", script: "Latin" },
  ...
  { code: "moh", name: "Mohawk", nativeName: "Kanien'kéha", script: "Latin" },
  { code: "mus", name: "Creek", nativeName: "Mvskoke", script: "Latin" },
  ...
  { code: "brh", name: "Brahui", nativeName: "براہوئی", script: "Arabic", rtl: true },
  { code: "bsk", name: "Burushaski", nativeName: "بروشسکی", script: "Arabic", rtl: true },
  { code: "cgg", name: "Chiga", nativeName: "Rukiga", script: "Latin" },
  { code: "cjm", name: "Eastern Cham", nativeName: "Chăm", script: "Latin" },
  { code: "dng", name: "Dungan", nativeName: "Хуэйзў йүян", script: "Cyrillic" },
  { code: "gbz", name: "Zoroastrian Dari", nativeName: "Dari", script: "Arabic", rtl: true },
  { code: "haz", name: "Hazaragi", nativeName: "هزارگی", script: "Arabic", rtl: true },
  { code: "hil", name: "Hiligaynon", nativeName: "Ilonggo", script: "Latin" },
  { code: "hnj", name: "Hmong Njua", nativeName: "Hmoob Ntsuab", script: "Latin" },
  { code: "khb", name: "Lü", nativeName: "ᦅᧄᦺᦑᦟᦹᧉ", script: "Tai_Tham" },
  { code: "kjg", name: "Khmu", nativeName: "Kmhmu'", script: "Latin" },
  { code: "kri", name: "Krio", nativeName: "Krio", script: "Latin" },
  { code: "lis", name: "Lisu", nativeName: "ꓡꓲꓢꓴ", script: "Lisu" },
  { code: "lmc", name: "Limilngan", nativeName: "Limilngan", script: "Latin" },
  { code: "mnw", name: "Mon", nativeName: "ဘာသာမန်", script: "Myanmar" },
  { code: "mww", name: "Hmong Daw", nativeName: "Hmoob Dawb", script: "Latin" },
  { code: "new", name: "Newari", nativeName: "नेपाल भाषा", script: "Devanagari" },
  { code: "nod", name: "Northern Thai", nativeName: "ᨣᩴᩤᩴᨾᩮᩥᩬᨦ", script: "Tai_Tham" },
  ...
  { code: "wbm", name: "Wa", nativeName: "Parauk", script: "Latin" },
  ...
  { code: "aar", name: "Afar", nativeName: "Qafar af", script: "Latin" },
  ...
  { code: "bal", name: "Balochi", nativeName: "بلوچی", script: "Arabic", rtl: true },
  { code: "bcc", name: "Southern Balochi", nativeName: "بلوچی", script: "Arabic", rtl: true },
  { code: "bgn", name: "Western Balochi", nativeName: "بلوچی", script: "Arabic", rtl: true },
  ...
  { code: "lad", name: "Ladino", nativeName: "Djudeo-Espanyol", script: "Latin" },
  ...
  { code: "phn", name: "Phoenician", nativeName: "𐤃𐤁𐤓𐤉𐤌 𐤊𐤍𐤏𐤍𐤉𐤌", script: "Phoenician" },
  { code: "sam", name: "Samaritan Aramaic", nativeName: "ארמית שומרונית", script: "Samaritan" },
  { code: "syc", name: "Classical Syriac", nativeName: "ܣܘܪܝܝܐ", script: "Syriac", rtl: true },
  ...
  { code: "brb", name: "Bribri", nativeName: "Bribri", script: "Latin" },
  ...
  { code: "quz", name: "Cusco Quechua", nativeName: "Qusqu Runasimi", script: "Latin" },
  ...
  { code: "hoc", name: "Ho", nativeName: "𑢹𑣉", script: "Warang_Citi" },
  ...
  { code: "laj", name: "Lango", nativeName: "Lëblaŋo", script: "Latin" },
  ...
  { code: "xal", name: "Kalmyk", nativeName: "Хальмг", script: "Cyrillic" },
  { code: "yua", name: "Yucatec Maya", nativeName: "Màaya t'àan", script: "Latin" },
