...
export const NON_INDIAN_LANGUAGES: DLTranslateLanguage[] = [
  ...
  { code: "kat_Geor", name: "Georgian", nativeName: "Georgian", isIndian: false, script: "Georgian", region: "Central Asia" },
  { code: "hye_Armn", name: "Armenian", nativeName: "Hayeren", isIndian: false, script: "Armenian", region: "Central Asia" },
  { code: "kaz_Cyrl", name: "Kazakh", nativeName: "Kazakh", isIndian: false, script: "Cyrillic", region: "Central Asia" },
  { code: "uzn_Latn", name: "Uzbek", nativeName: "Uzbek", isIndian: false, script: "Latin", region: "Central Asia" },
  { code: "kir_Cyrl", name: "Kyrgyz", nativeName: "Kyrgyz", isIndian: false, script: "Cyrillic", region: "Central Asia" },
  { code: "tgk_Cyrl", name: "Tajik", nativeName: "Tajik", isIndian: false, script: "Cyrillic", region: "Central Asia" },
  { code: "tuk_Latn", name: "Turkmen", nativeName: "Turkmen", isIndian: false, script: "Latin", region: "Central Asia" },
  { code: "bod_Tibt", name: "Tibetan", nativeName: "Tibetan", isIndian: false, script: "Tibetan", region: "Central Asia" },
  { code: "dzo_Tibt", name: "Dzongkha", nativeName: "Dzongkha", isIndian: false, script: "Tibetan", region: "Central Asia" },
  { code: "tat_Cyrl", name: "Tatar", nativeName: "Tatar", isIndian: false, script: "Cyrillic", region: "Central Asia" },
  { code: "bak_Cyrl", name: "Bashkir", nativeName: "Bashkir", isIndian: false, script: "Cyrillic", region: "Central Asia" },
  { code: "crh_Latn", name: "Crimean Tatar", nativeName: "Crimean Tatar", isIndian: false, script: "Latin", region: "Central Asia" },
