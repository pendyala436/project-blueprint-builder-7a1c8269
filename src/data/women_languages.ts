// Women Profile Languages - All 382+ Languages
// Complete language list for women user profiles

export interface WomenLanguage {
  code: string;
  name: string;
  nativeName: string;
  script?: string;
...
export const womenLanguages: WomenLanguage[] = [
  // ================================================================
...
export const getWomenLanguageName = (code: string): string => {
  const language = womenLanguages.find(lang => lang.code === code);
  return language?.name || code;
};

// Get native name by code
export const getWomenLanguageNativeName = (code: string): string => {
  const language = womenLanguages.find(lang => lang.code === code);
