    ...
    try {
      ...
      if (!error && data && data.totals) {
        ...
        setAnalytics({
          ...
          adminProfit,
          menRecharges,
          menSpent: Math.max(Number(totals.men_spent) || 0, Number(totals.women_earnings) || 0),
          womenEarnings: Math.min(Number(totals.women_earnings) || 0, Number(totals.men_spent) || 0),
          womenWithdrawals,
