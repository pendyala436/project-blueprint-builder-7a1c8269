...
export const TypingModeSelector: React.FC<TypingModeSelectorProps> = memo(({
  ...
  const modes: TypingModeInfo[] = [
    {
      id: 'native',
      name: t('chat.mode.native', 'Native Mode'),
      description: t('chat.mode.nativeDesc', 'Type in your mother tongue'),
      icon: <Languages className="h-4 w-4" />,
      preview: userLanguage,
      afterSend: userLanguage,
      receiverSees: receiverLanguage,
    },
    {
      id: 'english-core',
      name: t('chat.mode.englishCore', 'English Core'),
      description: t('chat.mode.englishCoreDesc', 'Type & display in English'),
    ...
    {
      id: 'english-meaning',
      name: t('chat.mode.englishMeaning', 'English (Meaning)'),
      description: t('chat.mode.englishMeaningDesc', 'Type English, show as native'),
      icon: <MessageSquareText className="h-4 w-4" />,
      preview: `${userLanguage} (translated)`,
      afterSend: `${userLanguage} (meaning-based)`,
      receiverSees: receiverLanguage,
    },
  ];
