...
import { Video, Crown, RefreshCw, Users } from 'lucide-react';
    ...
    <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-transparent">
      <CardHeader className="pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Invite same-language men for exclusive 30-minute video calls. Set your gift price and earn 50%!
        </p>
      </CardHeader>
      <CardContent>
              ...
              {sameLanguageMen.map((user) => (
                <div
                  ...
                  className={cn(
                    ...
                    user.isFree ? "border-success/30" : "border-border/50 opacity-60"
                  )}
                >
