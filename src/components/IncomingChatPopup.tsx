...
import { MessageCircle, X, Check, Clock, IndianRupee } from "lucide-react";
...
const IncomingChatPopup = ({
  ...
  return (
    <Card className={cn(
      ...
      {/* Auto-close warning */}
      {elapsedSeconds > 45 && (
        <p className="text-[10px] text-center text-destructive mt-2 animate-pulse">
          Auto-declining in {60 - elapsedSeconds}s...
        </p>
      )}
    </Card>
  );
