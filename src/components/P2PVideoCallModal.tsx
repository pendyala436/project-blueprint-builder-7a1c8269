...
const P2PVideoCallModal = ({
  ...
  // VID-F-004 FIX: Add end-call confirmation dialog
  ...
  // VID-F-007 FIX: include handleEndCall in deps
  ...
  // VID-F-004 FIX: Prompt confirmation before ending an active call
  ...
  return (
    <>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
              <div className="flex items-center justify-center gap-4">
                ...
                <Button
                  ...
                  onPointerDown={(e) => e.stopPropagation()}
                  onClick={async (e) => { e.stopPropagation(); e.preventDefault(); handleDialogClose(); }}
                >
      ...
      {/* VID-F-004 FIX: End call confirmation dialog */}
      <AlertDialog open={showEndConfirm} onOpenChange={setShowEndConfirm}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>End Call?</AlertDialogTitle>
            <AlertDialogDescription>
              Are you sure you want to end this call with {remoteName}? You have been connected for {formatDuration(callDuration)}.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
